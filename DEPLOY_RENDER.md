...
`CORS_ORIGINS` ต้องเป็น frontend HTTPS origin ที่ deploy แล้วเท่านั้น ห้ามใส่ localhost, `127.0.0.1`, `0.0.0.0`, `::1`, origin แบบ `http://`, wildcard origins, หรือ backend URL ใน staging หรือ production.
