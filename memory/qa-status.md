...
- API smoke with `--require-admin` now passes 29 checks plus 1 local live-chat skip, including non-mutating report creation, admin wallet, and admin report PATCH/action validation.
