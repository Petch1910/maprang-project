...
- `api:smoke:test` now runs in `qa:local`, CI, and Production Smoke to guard API smoke readiness/image helper regressions and API smoke runner import safety without calling a backend.
