...
- ยืนยัน repo-owned gate ล่าสุดด้วย `bun run qa:repo` ก่อนเริ่ม staging/live-provider รอบถัดไป; รอบล่าสุดวันที่ 2026-05-25 ผ่านหลัง release handoff URL guards, production/staging CORS origin path/query/hash guards, frontend env/Admin Health URL guard และ diagnostic wording hardening.
