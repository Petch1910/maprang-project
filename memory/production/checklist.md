...
- ยืนยัน repo-owned gate ล่าสุดด้วย `bun run qa:repo`; รอบ 2026-06-01 ผ่านหลัง namespace/computed `Reflect.apply` Promise reject guard โดย backend tests ยังอยู่ที่ 178 pass / 611 expects, docs command audit อยู่ที่ 350 refs และ frontend static/route/build/bundle budget ผ่าน.
