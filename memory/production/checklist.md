...
- `bun run qa:repo` ล่าสุดผ่านหลัง dangerous link protocol guard แล้ว พร้อม backend tests 177 pass / 609 expects, frontend static audit/build/bundle budget, API audit, route/menu audit, docs/memory/knowledge gates; DB persistence suites ยัง skip เฉพาะเพราะ local Postgres ไม่ได้รัน.
