...
- Frontend/backend raw error log guards now also cover console call/apply/bind/Reflect.apply method-forwarding syntax, including apply-array raw error arguments, bind-invoked calls, and Reflect.apply arrays; this is repo-owned hardening, not an external deploy blocker.
