...
- Frontend/backend raw error log guards now also cover console call/apply/bind method-forwarding syntax, including apply-array raw error arguments and bind-invoked calls; this is repo-owned hardening, not an external deploy blocker.
