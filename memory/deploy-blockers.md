...
- Frontend/backend raw error log guards now also cover console call/apply method-forwarding syntax, including apply-array raw error arguments; this is repo-owned hardening, not an external deploy blocker.
