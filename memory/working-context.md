...
- Structured knowledge packs now use Thai-first runtime policy, creator guidance, chat style, relationship rules, and scene rules; knowledge audit blocks the old English snippets from returning.
