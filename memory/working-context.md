...
- Live image/API smoke helper messages now avoid mixed English fix copy for billing, quota, invalid image keys, placeholder fallback, missing image URLs, and local SVG placeholders while preserving exact env names and commands.
