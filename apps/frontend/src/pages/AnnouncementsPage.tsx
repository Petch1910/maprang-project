...
const mockAnnouncements: Announcement[] = [
  ...
  },
  {
    ...
    content: 'ขอเชิญนักสร้างการ์ดบอร์ดร่วมกิจกรรมออกแบบตัวละครโรลเพลย์ในธีม "ไซเบอร์พังก์เรืองแสง (Cyberpunk)" และ "ป่าเวทมนตร์ในจินตนาการ" ชิงเงินรางวัลเครดิตจำลองและคอยน์โบนัสรวมกว่า 50,000 โทเคน ประกวดได้ตั้งแต่วันนี้ถึงสิ้นเดือนมิถุนายนนี้!',
    date: '2026-06-05',
    category: 'event'
  },
  {
