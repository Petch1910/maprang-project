...
const faqs: FaqItem[] = [
  {
    q: 'เครดิตใช้งานคืออะไร และเพิ่มยอดได้จากที่ไหน?',
    a: 'โหมดในเครื่องใช้เครดิตเป็นตัวนับการใช้งาน AI เพื่อดูต้นทุนและป้องกันการยิงซ้ำ ระบบชำระเงินยังไม่อยู่ในแผน v1 ถ้าต้องปรับยอดให้ใช้เครื่องมือผู้ดูแลในหน้าเครดิตใช้งาน',
  },
  {
    q: 'ทำไมบอทบางครั้งตอบสั้นหรือยังไม่ลื่น?',
    a: 'ความยาวคำตอบขึ้นกับผู้ให้บริการ งบคำสั่ง เครดิตใช้งาน และโหมดในเครื่อง ถ้าต้องการเช็คคุณภาพจริงให้ดูหน้าตรวจระบบและหน้าตรวจคำสั่ง เพื่อดูโมเดล งบคำตอบ บริบท และสถานะผู้ให้บริการ',
  },
  {
