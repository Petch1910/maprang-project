...
export const routeMenuAuditRows: RouteMenuAuditRow[] = [
  ...
  },
  {
    ...
    disabledReason: 'คำสั่งกู้คืน/ลบ/แก้ชื่อ/จัดการหลายรายการถูกปิดเฉพาะระหว่างกำลังบันทึกคำสั่งนั้นหรือยังไม่ได้เลือกแชท พร้อม title ภาษาไทยบอกเหตุผลทั้ง toolbar, เมนูแชท, ปุ่มกู้คืน และ dialog ยืนยัน',
