...
export const routeMenuAuditRows: RouteMenuAuditRow[] = [
  ...
  },
  {
    ...
    result:
      'รายการแชทเปิดกลับไป /chat/:chatId ได้ เมนูแก้ชื่อ/ปักหมุดแชท/จัดเก็บแชท/ลบแชทมีผลจริง โหมดเลือกหลายแชทรองรับจัดเก็บ/กู้คืน/ลบหลายรายการ และผ่านการตรวจบนเดสก์ท็อปกับมือถือแล้ว',
