...
export const routeMenuAuditRows: RouteMenuAuditRow[] = [
  ...
  },
  {
    ...
    disabledReason: 'ช่องพิมพ์, ปุ่มส่ง, ตัวช่วยข้อความ, คำชวนคุย, ปุ่มฉาก, สถานะโลก และไลก์ถูกปิดพร้อม title เมื่อข้อความว่าง, กำลังสตรีม, ยังไม่เริ่มแชท, กำลังบันทึก, หรือโทเคนไม่พอ',
