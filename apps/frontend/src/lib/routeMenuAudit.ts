...
export const routeMenuAuditRows: RouteMenuAuditRow[] = [
  ...
  },
  {
    ...
    disabledReason: 'ไม่มีปุ่มที่ถูกปิดถาวร คำสั่งลบให้ยืนยันก่อนเพื่อกันพลาด และ toolbar เลือกหลายแชท/แก้ชื่อแชทมี title ภาษาไทยเมื่อถูกปิด',
  ...
  },
  {
    ...
    disabledReason: 'ไม่มีปุ่มที่ถูกปิดถาวร รีเฟรชมี title บอกว่ากำลังโหลดสถานะระบบเมื่อถูกปิด',
