...
export const routeMenuAuditRows: RouteMenuAuditRow[] = [
  ...
  },
  {
    ...
    result:
      'เห็นความพร้อมของ DB, AI, Runtime แชท, Supabase, พื้นที่เก็บรูปแบบลิงก์ลงชื่อ, CORS, การตรวจเส้นทาง และขั้นต่อไปของแต่ละตัวกั้นในหน้าเดียว; local runtime จะแสดง local mock พร้อมเล่น, แชท local สำหรับ QA, และ local/mock-roleplay พร้อมไปตัวตรวจพรอมป์และชุดทดสอบอัตโนมัติได้',
