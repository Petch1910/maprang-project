...
export const routeErrorMessages: Record<string, string> = {
  ...
  daily_login_failed: 'รับรางวัลเข้าสู่ระบบประจำวันไม่สำเร็จ กรุณาลองใหม่อีกครั้ง',
  database_not_configured: 'ยังไม่ได้ตั้งค่าฐานข้อมูลสำหรับใช้งานส่วนนี้',
  failed_to_load_stats: 'โหลดสถิติการเข้าสู่ระบบไม่สำเร็จ กรุณาลองใหม่อีกครั้ง',
  generation_job_not_found: 'ไม่พบงานสร้างภาพนี้ หรือคุณไม่มีสิทธิ์เข้าถึง',
  generation_job_cancel_unavailable: 'งานสร้างภาพนี้จบแล้ว จึงยกเลิกไม่ได้',
  generation_output_not_found: 'ไม่พบไฟล์ผลลัพธ์นี้ หรือคุณไม่มีสิทธิ์เข้าถึง',
  generation_output_file_unavailable: 'ยังไม่มีไฟล์ผลลัพธ์ที่นำไปใช้ได้',
  generation_output_image_required: 'ใช้ได้เฉพาะผลลัพธ์ประเภทรูปภาพ',
  generation_storage_unavailable: 'ยังสร้างลิงก์ไฟล์ผลลัพธ์ไม่ได้ กรุณาลองใหม่ภายหลัง',
  ...
  provider_key_invalid: 'API key ส่วนตัวไม่ถูกต้อง กรุณาตรวจสอบแล้วลองใหม่',
