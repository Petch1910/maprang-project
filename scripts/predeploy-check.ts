    ...
    run: async () => {
      ...
      requireIncludes(
        ...
        [
          ...
          '`qa:repo` ล่าสุดผ่านวันที่ 2026-06-06',
          'qa:full',
          'dark UI polish',
          ...
          'docs command audit ครอบ 405 refs',
          'docs command audit 354 refs',
          'knowledge audit ครอบ 12 files / 5 structured packs',
          'Backend tests ล่าสุดผ่าน 180 tests / 769 expects',
          'backend security audit 37 tests / 242 expects',
          'frontend static audit 39 tests / 231 expects',
          'admin health deploy-runbook docs sync',
    ...
    run: async () => {
      ...
      requireIncludes(
        ...
        [
          ...
          'STAGING_RUNBOOK.md',
          '/admin/health',
          'Latest local QA gate after relationship/creator preset hardening',
          'import-cycle audit 125 files / 296 edges',
          'backend tests 180 pass / 769 expects',
          '/path',
          'API route audit',
          'weak coverage',
          'admin-smoke',
      ...
      requireIncludes(
        ...
        [
          ...
          'docs command audit 354 refs',
          'full local QA gate passed after dark UI polish',
          'agent handoff baseline sync',
          'admin health deploy-runbook docs sync',
          'docs command audit 405 refs',
          'import-cycle audit 125 files / 296 edges',
          'backend tests 180 pass / 769 expects',
          'smoke doctor local backend+DB ready',
          'API smoke 34 pass / 2 live-provider skips',
