    ...
    run: async () => {
      ...
      requireIncludes(
        ...
        [
          ...
          "console\\\\.(?:error|warn)\\\\s*\\\\([\\\\s\\\\S]*?,\\\\s*(?:\\\\(\\\\s*)?${rawErrorExpressionPatternFor('error')}",
          "providerFailure[\\\\s\\\\S]*?,\\\\s*${rawErrorExpressionPatternFor('error')}",
          "console\\\\.(?:error|warn)\\\\s*\\\\(\\\\s*(?:\\\\(\\\\s*)?${rawErrorExpressionPatternFor('error')}",
          '\\.\\s*\\$queryRawUnsafe\\s*\\(',
      ...
      requireIncludes(
        ...
        [
          ...
          '[\\s\\S]*?,\\s*error\\b[\\s\\S]*?\\)',
          'console\\.(?:error|warn)\\s*\\(\\s*error\\b\\s*(?:,|\\))',
          "href\\s*=\\s*\\{\\s*([\"'`])#\\1\\s*\\}",
          "to\\s*=\\s*\\{\\s*([\"'`])#\\1\\s*\\}",
