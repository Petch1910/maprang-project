    ...
    run: async () => {
      ...
      requireIncludes(
        ...
        [
          ...
          'docs command audit ครอบ 343 refs',
    ...
    run: async () => {
      ...
      requireIncludes(
        ...
        [
          ...
          "${consoleErrorWarnCallPrefix}[\\\\s\\\\S]*?,\\\\s*(?:\\\\(\\\\s*)?${rawErrorExpressionPatternFor('error')}",
          "providerFailure[\\\\s\\\\S]*?,\\\\s*${rawErrorExpressionPatternFor('error')}",
          "${consoleErrorWarnCallPrefix}\\\\s*(?:\\\\(\\\\s*)?${rawErrorExpressionPatternFor('error')}",
          '\\.\\s*\\$queryRawUnsafe\\s*\\(',
