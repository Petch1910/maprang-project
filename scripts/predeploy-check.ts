...
const checks: Check[] = [
    ...
    run: async () => {
      ...
      requireIncludes(
        ...
        [
          ...
          'Latest local/repo baseline is 2026-06-18',
          'process-mining/context snapshot work',
          'response-quality controls',
          'backend:check',
          'Full Playwright `e2e:smoke` passed against local frontend/backend',
          'memory audit',
          '42 Markdown files',
          'docs command audit',
          '430 refs',
          'knowledge audit',
          '343 tests / 1496 expects',
          'backend security audit 39 tests / 246 expects',
          '80 backend routes + 56 frontend helper calls',
    ...
    run: async () => {
      ...
      requireIncludes(
        ...
        [
          ...
          'STAGING_RUNBOOK.md',
          '/admin/health',
          'Latest agent/production checklist baseline addendum',
          'docs command audit 471 refs',
          'test coverage audit 67 files / 35 root test scripts',
          'import-cycle audit 139 files / 325 edges',
          'backend security audit 39 tests / 246 expects',
          'API audit 58 backend routes + 34 frontend helper calls',
          'backend tests 271 pass / 1226 expects',
          'local roleplay normal/stream verified with `totalTokens=0`',
          'Playwright e2e smoke 4/4 desktop+mobile with QA seed restored',
          '/path',
          'API route audit',
          'weak coverage',
          'admin-smoke',
      ...
      requireIncludes(
        ...
        [
          ...
          'docs command audit 354 refs',
          'agent handoff baseline sync',
          'local roleplay stream guard sync and browser smoke pass',
          'docs command audit 471 refs',
          'test coverage audit 67 files / 35 root test scripts',
          'import-cycle audit 139 files / 325 edges',
          'backend security audit 39 tests / 246 expects',
    ...
    run: async () => {
      ...
      requireIncludes(
        ...
        [
          ...
          'buildStagingNextDeploySteps',
          'buildProductionNextDeploySteps',
          'staging gate ผ่านแล้ว',
          'ปิด staging blockers ให้ผ่านก่อนตั้ง verification flags ของ production',
          ...
          'โดยไม่มี credential/userinfo หรือ path/query/hash',
    ...
    run: async () => {
      ...
      requireIncludes(
        ...
        [
          ...
          'frontend XSS/link guard',
          'supabase:storage:check',
          'manual/staging abuse QA',
          'ABUSE_QA_CHECKLIST.md',
        ],
        'SECURITY_CHECKLIST.md',
      )
      requireIncludes(
        ...
        [
          ...
          'Storage/avatar',
          'Automated Coverage Map',
          'Gate อัตโนมัติที่ต้องผ่าน',
          'สิ่งที่ล็อกแล้วใน repo',
          'ยังต้องลองด้วยมือ/staging',
          'frontend:static:audit',
          'eval:local',
          'supabase:storage:check',
          'cross-user guessing',
      ...
      requireIncludes(
        ...
        [
          'prefers MIKA',
          'validates backend root identity before deeper smoke work',
          'validates avatar upload shape',
          'validates local wallet and usage summary shape',
          'validates local profile content settings and persona shape',
          ...
          'formats object-shaped local smoke errors without stringifying raw objects',
          'runs local smoke through an importable runner',
          "'/me/usage'",
          "'/me/content-settings'",
          "'/me/persona'",
          ...
          'creatorDraftImageProvider',
          'creatorDraftSource',
          'creatorPreviewReplyChars',
          'creatorPreviewModel',
          'creatorPreviewSource',
          'creatorPreviewTokens',
          'chatReplyChars',
          'chatTokens',
          'chatSceneMode',
          'chatPendingEvents',
          'chatRelationshipStatus',
          'chatRelationshipEvents',
          'streamReplyChars',
          'streamTokens',
          'streamEvents',
          'streamPendingEvents',
      ...
      requireIncludes(
        ...
        [
          ...
          "'/chats'",
          '/chats/${chat.chatId}/messages?limit=5',
          '/chats/${chat.chatId}/world-state',
          'tokenBalance',
          'usageDailyDays',
          'walletTransactions',
          'contentMaxRating',
      ...
      requireIncludes(
        ...
        [
          ...
          'collectionConstructorTypeArguments',
          'collectionMapConstructorBase',
          'collectionSetConstructorBase',
          'collectionMapConstructorAccessor',
          'collectionSetConstructorAccessor',
      ...
      requireIncludes(
        ...
        [
          ...
          '\\s*\\.\\s*json\\s*\\(',
          '\\s*\\.\\s*text\\s*\\(',
          'rawFrontendFetchPattern',
          'allowedFrontendFetchFiles',
          'rawFrontendFetchMessage',
          'ห้ามเรียก fetch ตรงนอก apps/frontend/src/lib/api.ts',
          'window\\s*\\.\\s*fetch',
  ...
  },
  {
    ...
    run: async () => {
      ...
      requireIncludes(
        e2eSmoke,
        ['ตรวจเส้นทาง/เมนู', 'ตรวจพรอมป์ก่อนยิงโมเดล', 'กฎคุมพรอมป์ของแพลตฟอร์ม', 'ทดสอบคุณภาพพรอมป์และบริบท', 'สรุปด่านค้างก่อนโปรดักชัน', 'ลำดับงานก่อนปล่อยจริง', 'bun run staging:verify + bun run e2e:smoke', 'bun run api:smoke:live', 'เช็กลิสต์ deploy', 'แถบแชท'],
        'tests/e2e/maprang-smoke.spec.ts',
      )
