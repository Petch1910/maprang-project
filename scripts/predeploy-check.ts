    ...
    run: async () => {
      ...
      requireIncludes(
        ...
        [
          ...
          'route error response is missing a Thai-first message',
      ...
      requireIncludes(
        ...
        [
          ...
          'contains mixed Admin Health wording that should be Thai-first',
          'contains mixed prompt/admin tooling wording that should be Thai-first',
          'contains mixed profile/tag helper wording that should be Thai-first',
          'image provider',
          'backend',
          'Lobby',
