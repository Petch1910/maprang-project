...
describe('predeploy check wiring', () => {
  test('keeps predeploy diagnostics Thai-first', async () => {
    ...
    expect(predeploy).toContain('bound reflection method alias')
    expect(predeploy).toContain('predeploy regression 494 expects')
    ...
    expect(predeploy).toContain('bound reflection method alias guard pass')
