...
describe('predeploy check wiring', () => {
  test('keeps predeploy diagnostics Thai-first', async () => {
    ...
    expect(predeploy).toContain('memory audit ครอบ 35 Markdown files')
    ...
    expect(predeploy).toContain('targetOrigin "*"')
    ...
    expect(predeploy).toContain('0025-add-frontend-cross-window-messaging-helper.md')
