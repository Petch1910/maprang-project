...
describe('predeploy check wiring', () => {
  test('keeps predeploy diagnostics Thai-first', async () => {
    ...
    expect(predeploy).toContain('computed bind reflection method alias')
    expect(predeploy).toContain('bindMethodAccessor')
    expect(predeploy).toContain("Reflect.get['bind'](Reflect)")
    expect(predeploy).toContain('predeploy regression 496 expects')
    ...
    expect(predeploy).toContain('computed bind reflection method alias guard pass')
