...
describe('backend security audit', () => {
  ...
  test('catches backend console method aliases', () => {
    const messages = messagesFor(`
        ...
        const reflectedErrorViaComputedGlobal = globalThis['Reflect'].get(console, 'error')
        ...
        const descriptorErrorViaComputedGlobal = globalThis['Object'].getOwnPropertyDescriptor(console, 'warn')?.value
  ...
  test('catches backend Reflect object aliases', () => {
    ...
    expect(
      messagesFor(`
        ...
        (new WeakSet<typeof Reflect>()).add(globalThis.Reflect)
        (new (WeakSet)<typeof Reflect>()).add(globalThis.Reflect)
        (new (WeakSet)<typeof Reflect>())?.add(globalThis.Reflect)
        (new (WeakSet)<typeof Reflect>())?.['add'](globalThis.Reflect)
        (new WeakSet<typeof Reflect>())?.['add'](globalThis.Reflect)
        (new globalThis.WeakSet<typeof Reflect>()).add(globalThis.Reflect)
        (new (globalThis.WeakSet)<typeof Reflect>()).add(globalThis.Reflect)
        (new (globalThis.WeakSet)<typeof Reflect>())?.['add'](globalThis.Reflect)
        (new globalThis['WeakSet']<typeof Reflect>()).add(globalThis.Reflect)
        (new (globalThis['WeakSet'])<typeof Reflect>()).add(globalThis.Reflect)
        ...
        (new (globalThis?.['WeakSet'])<typeof Reflect>()).add(globalThis.Reflect)
        (new (globalThis?.['WeakSet'])<typeof Reflect>())?.['add'](globalThis.Reflect)
        (new Set()).add(globalThis.Reflect)
        (new Set())['add'](globalThis.Reflect)
        (new Set())?.add(globalThis.Reflect)
        (new Set())?.['add'](globalThis.Reflect)
        (new Set()).add?.(globalThis.Reflect)
        (new Set())['add']?.(globalThis.Reflect)
        (new Set<typeof Reflect | Array<typeof Reflect>>()).add(globalThis.Reflect)
        (new Set<typeof Reflect | Array<typeof Reflect>>())?.['add'](globalThis.Reflect)
        (new globalThis.Set<typeof Reflect | Array<typeof Reflect>>()).add(globalThis.Reflect)
        (new globalThis['Set']<typeof Reflect | Array<typeof Reflect>>())?.['add'](globalThis.Reflect)
        (new (globalThis.Set)<typeof Reflect | Array<typeof Reflect>>()).add(globalThis.Reflect)
        (new (globalThis['Set'])<typeof Reflect | Array<typeof Reflect>>())?.['add'](globalThis.Reflect)
        (new (globalThis?.Set)<typeof Reflect | Array<typeof Reflect>>()).add(globalThis.Reflect)
  ...
  test('catches Reflect.apply console retrieval targets', () => {
    ...
    expect(messages.filter((message) => message === rawLogMessage)).toHaveLength(58)
  })
  ...
  test('catches backend console object aliases', () => {
    const messages = messagesFor(`
        ...
        const computedNamespaceReflectedLogger = globalThis['Reflect'].get(globalThis, 'console')
  ...
  test('catches route catch raw error returns', () => {
    ...
    expect(
      messagesFor(`
        ...
        (new (WeakMap)<object, Promise<void>>())?.['set']({}, Promise.reject)
        (new WeakMap<object, Promise<void>>())?.['set']({}, Promise.reject)
        (new globalThis.WeakMap<object, Promise<void>>()).set({}, Promise.reject)
        (new (globalThis.WeakMap)<object, Promise<void>>()).set({}, Promise.reject)
        (new (globalThis.WeakMap)<object, Promise<void>>())?.['set']({}, Promise.reject)
        (new globalThis['WeakMap']<object, Promise<void>>()).set({}, Promise.reject)
        (new (globalThis['WeakMap'])<object, Promise<void>>()).set({}, Promise.reject)
        ...
        (new Map<string, Promise<void>>())?.['set']('reject', Promise.reject)
        (new globalThis.Map<string, Promise<void>>()).set('reject', Promise.reject)
        (new globalThis['Map']<string, Promise<void>>())?.['set']('reject', Promise.reject)
        (new (globalThis.Map)<string, Promise<void>>()).set('reject', Promise.reject)
        (new (globalThis['Map'])<string, Promise<void>>())?.['set']('reject', Promise.reject)
        (new (globalThis?.Map)<string, Promise<void>>()).set('reject', Promise.reject)
    ...
    expect(
      messagesFor(`
        ...
        const { reject: computedReflectNamespaceReject } = globalThis['Reflect'].get(globalThis, 'Promise')
    ...
    expect(
      messagesFor(`
        ...
        const computedReflectPromiseCtor = globalThis['Reflect'].get(globalThis, 'Promise')
    ...
    expect(
      messagesFor(`
        ...
        (new WeakSet<PromiseConstructor>()).add(globalThis.Promise)
        (new (WeakSet)<PromiseConstructor>()).add(globalThis.Promise)
        (new (WeakSet)<PromiseConstructor>())?.add(globalThis.Promise)
        (new (WeakSet)<PromiseConstructor>())?.['add'](globalThis.Promise)
        (new WeakSet<PromiseConstructor>())?.['add'](globalThis.Promise)
        (new globalThis.WeakSet<PromiseConstructor>()).add(globalThis.Promise)
        (new (globalThis.WeakSet)<PromiseConstructor>()).add(globalThis.Promise)
        (new (globalThis.WeakSet)<PromiseConstructor>())?.['add'](globalThis.Promise)
        (new globalThis['WeakSet']<PromiseConstructor>()).add(globalThis.Promise)
        (new (globalThis['WeakSet'])<PromiseConstructor>()).add(globalThis.Promise)
        ...
        (new (globalThis?.['WeakSet'])<PromiseConstructor>()).add(globalThis.Promise)
        (new (globalThis?.['WeakSet'])<PromiseConstructor>())?.['add'](globalThis.Promise)
        (new Set()).add(globalThis.Promise)
        (new Set())['add'](globalThis.Promise)
        (new Set())?.add(globalThis.Promise)
        (new Set())?.['add'](globalThis.Promise)
        (new Set()).add?.(globalThis.Promise)
        (new Set())['add']?.(globalThis.Promise)
        (new Set<PromiseConstructor | Array<PromiseConstructor>>()).add(globalThis.Promise)
        (new Set<PromiseConstructor | Array<PromiseConstructor>>())?.['add'](globalThis.Promise)
        (new globalThis.Set<PromiseConstructor | Array<PromiseConstructor>>()).add(globalThis.Promise)
        (new globalThis['Set']<PromiseConstructor | Array<PromiseConstructor>>())?.['add'](globalThis.Promise)
        (new (globalThis.Set)<PromiseConstructor | Array<PromiseConstructor>>()).add(globalThis.Promise)
        (new (globalThis['Set'])<PromiseConstructor | Array<PromiseConstructor>>())?.['add'](globalThis.Promise)
        (new (globalThis?.Set)<PromiseConstructor | Array<PromiseConstructor>>()).add(globalThis.Promise)
    ...
    expect(
      messagesFor(`
        ...
        const reflectedRejectViaComputedGlobal = globalThis['Reflect'].get(Promise, 'reject')
        ...
        const computedReflectedNamespaceReject = Reflect.get(globalThis['Reflect'].get(globalThis, 'Promise'), 'reject')
