...
export async function collectMemoryAuditResult(): Promise<MemoryAuditResult> {
  ...
  requireIncludes(
    ...
    [
      ...
      'call/apply/bind/Reflect.apply/Reflect.get/global-console/alias raw error log guard',
      'console method aliases',
      'console object aliases',
      'raw frontend classifier/UI message guard',
  ...
  requireIncludes(
    ...
    [
      ...
      'raw UI error throw guard',
      'call/apply/bind/Reflect.apply/Reflect.get/global-console/alias raw error log guard',
      'console alias raw error log guard',
      'console object alias raw error log guard',
      'raw frontend classifier/UI message guard',
      'cross-window messaging helper/guard',
      'backend raw route return guard',
      'memory audit 36 Markdown files',
