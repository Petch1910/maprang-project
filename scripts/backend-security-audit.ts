...
const descriptorConsoleErrorWarnValue = String.raw`(?:${objectDescriptorCallPrefix}\s*${consoleObjectAccessor}\s*,\s*["'](?:error|warn)["']\s*\)|${objectDescriptorMethodCallPrefix}${consoleObjectAccessor}\s*,\s*["'](?:error|warn)["']\s*\)|${objectDescriptorMethodApplyPrefix}${consoleObjectAccessor}\s*,\s*["'](?:error|warn)["']\s*\]\s*\)|${objectDescriptorMethodBindPrefix}${consoleObjectAccessor}\s*,\s*["'](?:error|warn)["']\s*\))\s*(?:\?\.|\.)\s*value`
