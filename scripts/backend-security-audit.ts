...
const reflectGetConsoleErrorWarnValue = String.raw`${reflectGetCallPrefix}\s*${consoleObjectAccessor}\s*,\s*["'](?:error|warn)["'](?:\s*,[^)]*)?\s*\)`
...
const descriptorConsoleErrorWarnValue = String.raw`${objectDescriptorCallPrefix}\s*${consoleObjectAccessor}\s*,\s*["'](?:error|warn)["']\s*\)\s*(?:\?\.|\.)\s*value`
...
const reflectGetPromiseRejectValue = String.raw`${reflectGetCallPrefix}\s*${promiseObjectAccessor}\s*,\s*["']reject["'](?:\s*,[^)]*)?\s*\)`
const descriptorPromiseRejectValue = String.raw`${objectDescriptorCallPrefix}\s*${promiseObjectAccessor}\s*,\s*["']reject["']\s*\)\s*(?:\?\.|\.)\s*value`
