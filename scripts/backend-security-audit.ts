...
const collectionMapConstructorAccessor = String.raw`(?:(?:(?:window|globalThis)\s*(?:\?\.|\.)\s*)?(?:Weak)?Map|(?:window|globalThis)\s*(?:\?\.)?\s*\[\s*["'](?:Weak)?Map["']\s*\])`
const collectionSetConstructorAccessor = String.raw`(?:(?:(?:window|globalThis)\s*(?:\?\.|\.)\s*)?(?:Weak)?Set|(?:window|globalThis)\s*(?:\?\.)?\s*\[\s*["'](?:Weak)?Set["']\s*\])`
