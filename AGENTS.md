...
4. `docs/MAPRANG_REMAINING_DEVELOPMENT_PLAN.md`
5. `memory/deploy-blockers.md`
6. `docs/MAPRANG_TEST_PLAN.md`
7. `docs/MAPRANG_CORE_PLAY_CREATE_PLAN.md`
8. `memory/ui-ux/current-direction.md`
