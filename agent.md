...
- E2E smoke ล่าสุดผ่าน 4 tests บน desktop และ mobile; command/config regression tests ผ่าน 12 tests และ Playwright จะ start dev server เฉพาะ local loopback targets
