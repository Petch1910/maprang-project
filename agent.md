...
- 2026-06-01: Frontend/backend static/security audits now reject computed call/apply reflection forwarding, including bracket-call/bracket-apply forms for `Reflect.get`, `Object.getOwnPropertyDescriptor`, and `Reflect.apply`, on top of the computed bind reflection method alias guard. Full deterministic qa:repo passed with memory audit 37 Markdown files, docs command audit 354 refs, predeploy regression 504 expects, frontend static audit 39 tests / 181 expects, backend security audit 37 tests / 192 expects, backend tests 178 pass / 611 expects, frontend build, and bundle budget green; external deploy blockers unchanged.
