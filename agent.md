...
- Backend tests ล่าสุดผ่าน 177 tests / 609 expects และ `qa:repo` ล่าสุดผ่านวันที่ 2026-05-26 หลัง frontend unmounted allowlist hardening; memory audit ครอบ 32 Markdown files, docs command audit ครอบ 334 refs, test coverage audit ครอบ 60 files / 33 root test scripts, API audit ครอบ 48 backend routes + 34 frontend helper calls, frontend static audit allowlist guard, frontend build, และ bundle budget
