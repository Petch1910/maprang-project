...
- Current addendum 2026-05-31: latest full `bun run qa:repo` passed after Promise executor raw reject guard for arrow/function/optional-call/call-apply-bind executors, Promise reject alias guard, Reflect.apply retrieved-target raw log guard, frontend raw UI Promise rejection guard, and backend raw route Promise rejection guard; backend remains 178 tests / 611 expects, and frontend static/route/build/bundle gates are green.
