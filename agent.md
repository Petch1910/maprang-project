...
- Current addendum 2026-06-01: full deterministic `bun run qa:repo` passed after the namespace/computed `Reflect.apply` Promise reject guard; backend remains 178 tests / 611 expects, docs command audit covers 350 refs, and frontend static/route/build/bundle gates are green.
