...
- Current addendum 2026-05-25: `memory:audit` now checks numbered decision files are linked from `memory/decisions/index.md`, and `predeploy:check` locks decision files through `0017-route-menu-future-surface-contract.md`.
